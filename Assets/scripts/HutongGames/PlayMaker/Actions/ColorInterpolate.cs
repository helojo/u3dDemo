namespace HutongGames.PlayMaker.Actions
{
    ...
    {
        [RequiredField, Tooltip("Array of colors to interpolate through.")]
        ...
        [UIHint(UIHint.Variable), RequiredField, Tooltip("Store the interpolated color in a Color variable.")]
        public FsmColor storeColor;
        [RequiredField, Tooltip("Interpolation time.")]
