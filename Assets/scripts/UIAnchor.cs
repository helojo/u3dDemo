...
public class UIAnchor : MonoBehaviour
{
    ...
    public void ForceUpdate()
    {
        ...
        {
            bool flag = false;
            UIWidget widget = (this.container != null) ? this.container.GetComponent<UIWidget>() : null;
            UIPanel panel = ((this.container != null) || (widget != null)) ? this.container.GetComponent<UIPanel>() : null;
            if (widget != null)
            {
                Bounds bounds = widget.CalculateBounds(this.container.transform.parent);
