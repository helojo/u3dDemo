...
[ExecuteInEditMode, AddComponentMenu("NGUI/UI/NGUI Sprite")]
public class UISprite : UIBasicSprite
{
    ...
    public override Vector4 drawingDimensions
    {
        get
        {
            ...
            if ((this.GetAtlasSprite() != null) && (base.mType != UIBasicSprite.Type.Tiled))
            {
                ...
                {
                    from += paddingRight * num11;
                    to -= paddingLeft * num11;
                }
                else
                {
                    from += paddingLeft * num11;
                    to -= paddingRight * num11;
                }
    ...
    public bool fillCenter
    {
        get
        {
            return (base.centerType != UIBasicSprite.AdvancedType.Invisible);
        }
        set
        {
