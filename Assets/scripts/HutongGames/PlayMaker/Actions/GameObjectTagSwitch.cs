namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Sends an Event based on a Game Object's Tag."), ActionCategory(ActionCategory.Logic)]
    public class GameObjectTagSwitch : FsmStateAction
    {
        ...
        [RequiredField, UIHint(UIHint.Variable), Tooltip("The GameObject to test.")]
