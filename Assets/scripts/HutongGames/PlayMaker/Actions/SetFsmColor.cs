namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Set the value of a Color Variable in another FSM."), ActionCategory(ActionCategory.StateMachine)]
    public class SetFsmColor : FsmStateAction
    {
        ...
        [Tooltip("The name of the FSM variable."), RequiredField, UIHint(UIHint.FsmColor)]
