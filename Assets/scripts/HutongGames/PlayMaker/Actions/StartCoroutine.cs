namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Start a Coroutine in a Behaviour on a Game Object. See Unity StartCoroutine docs."), ActionCategory(ActionCategory.ScriptControl)]
    public class StartCoroutine : FsmStateAction
    {
        [CompilerGenerated]
        private static Dictionary<string, int> <>f__switch$map6;
        [RequiredField, Tooltip("The Behaviour that contains the method to start as a coroutine."), UIHint(UIHint.Behaviour)]
        public FsmString behaviour;
        private MonoBehaviour component;
        [UIHint(UIHint.Coroutine), Tooltip("The name of the coroutine method."), RequiredField]
