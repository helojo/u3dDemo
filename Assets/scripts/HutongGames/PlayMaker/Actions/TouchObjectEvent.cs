namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Sends events when an object is touched. Optionally filter by a fingerID. NOTE: Uses the MainCamera!"), ActionCategory(ActionCategory.Device)]
    public class TouchObjectEvent : FsmStateAction
    {
        [Tooltip("Only detect touches that match this fingerID, or set to None.")]
        public FsmInt fingerId;
        [RequiredField, CheckForComponent(typeof(Collider)), Tooltip("The Game Object to detect touches on.")]
        ...
        [UIHint(UIHint.Variable), Tooltip("Store the surface normal vector where the object was touched.")]
        public FsmVector3 storeHitNormal;
        [UIHint(UIHint.Variable), Tooltip("Store the world position where the object was touched.")]
