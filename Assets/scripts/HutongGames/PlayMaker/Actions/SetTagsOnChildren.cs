namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Set the Tag on all children of a GameObject. Optionally filter by component."), ActionCategory(ActionCategory.GameObject)]
    public class SetTagsOnChildren : FsmStateAction
    {
        private System.Type componentFilter;
        [Tooltip("Only set the Tag on children with this component."), UIHint(UIHint.ScriptComponent)]
        public FsmString filterByComponent;
        [Tooltip("GameObject Parent"), RequiredField]
        public FsmOwnerDefault gameObject;
        [Tooltip("Set Tag To..."), UIHint(UIHint.Tag), RequiredField]
