namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Sends Events based on the comparison of 2 Floats."), ActionCategory(ActionCategory.Logic)]
    public class FloatCompare : FsmStateAction
    {
        ...
        [RequiredField, Tooltip("The first float variable.")]
        ...
        [RequiredField, Tooltip("Tolerance for the Equal test (almost equal).")]
