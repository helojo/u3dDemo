namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Finds a Game Object by Name and/or Tag."), ActionCategory(ActionCategory.GameObject)]
    public class FindGameObject : FsmStateAction
    {
        ...
        [RequiredField, UIHint(UIHint.Variable), Tooltip("Store the result in a GameObject variable.")]
