namespace HutongGames.PlayMaker.Actions
{
    ...
    public class AudioPlay : FsmStateAction
    {
        ...
        [RequiredField, CheckForComponent(typeof(AudioSource)), Tooltip("The GameObject with an AudioSource component.")]
        public FsmOwnerDefault gameObject;
        [Tooltip("Optionally play a 'one shot' AudioClip. NOTE: Volume cannot be adjusted while playing a 'one shot' AudioClip."), ObjectType(typeof(AudioClip))]
