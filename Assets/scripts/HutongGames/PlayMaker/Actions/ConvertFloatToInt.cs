namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionCategory(ActionCategory.Convert), Tooltip("Converts a Float value to an Integer value.")]
    public class ConvertFloatToInt : FsmStateAction
    {
        ...
        [UIHint(UIHint.Variable), RequiredField, Tooltip("Store the result in an Integer variable.")]
