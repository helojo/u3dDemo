...
public class UIBetterGrid : MonoBehaviour
{
    ...
    public void WrapContent()
    {
        ...
        if (this.mHorizontal)
        {
            ...
            for (int j = 0; j < this.mChildren.size; j++)
            {
                ...
                if (this.cullContent)
                {
                    ...
                    {
                        NGUITools.SetActive(transform.gameObject, (num6 > num3) && (num6 < num4), false);
                    }
                }
            }
        }
        ...
        {
            float num7 = worldCorners[0].y - (this.itemSize * 1f);
            float num8 = worldCorners[2].y + (this.itemSize * 1.8f);
