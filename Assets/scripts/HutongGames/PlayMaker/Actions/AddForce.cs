namespace HutongGames.PlayMaker.Actions
{
    ...
    public class AddForce : FsmStateAction
    {
        ...
        [CheckForComponent(typeof(Rigidbody)), RequiredField, Tooltip("The GameObject to apply the force to.")]
            ...
            if (ownerDefaultTarget != null)
            {
                ...
                else
                {
                    ...
                    if (this.space == Space.World)
                    {
                        ...
                        {
                            ownerDefaultTarget.rigidbody.AddForceAtPosition(force, this.atPosition.Value, this.forceMode);
                        }
                        else
                        {
                            ownerDefaultTarget.rigidbody.AddForce(force, this.forceMode);
                        }
                    }
                    else
                    {
                        ownerDefaultTarget.rigidbody.AddRelativeForce(force, this.forceMode);
                    }
                }
            }
        }
