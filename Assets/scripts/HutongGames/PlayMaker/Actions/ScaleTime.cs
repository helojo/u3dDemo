namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Scales time: 1 = normal, 0.5 = half speed, 2 = double speed."), ActionCategory(ActionCategory.Time)]
    public class ScaleTime : FsmStateAction
    {
        ...
        [HasFloatSlider(0f, 4f), Tooltip("Scales time: 1 = normal, 0.5 = half speed, 2 = double speed."), RequiredField]
