namespace HutongGames.PlayMaker.Actions
{
    ...
    {
        [Tooltip("The Bool variable to test."), RequiredField, UIHint(UIHint.Variable)]
        public FsmBool boolVariable;
        [Tooltip("Repeat every frame. Useful if the Bool variable is changing.")]
        public bool everyFrame;
        [Tooltip("Float value if Bool variable is false.")]
        public FsmFloat falseValue;
        [UIHint(UIHint.Variable), RequiredField, Tooltip("The Float variable to set based on the Bool variable value.")]
