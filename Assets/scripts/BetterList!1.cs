...
public class BetterList<T>
{
    ...
    {
        return new <GetEnumerator>c__Iterator1<T> { <>f__this = (BetterList<T>) this };
    }
    ...
    [CompilerGenerated]
    private sealed class <GetEnumerator>c__Iterator1 : IEnumerator, IDisposable, IEnumerator<T>
    {
        internal T $current;
        internal int $PC;
