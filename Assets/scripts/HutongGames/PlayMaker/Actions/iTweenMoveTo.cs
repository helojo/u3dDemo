namespace HutongGames.PlayMaker.Actions
{
    ...
    public class iTweenMoveTo : iTweenFsmAction
    {
        ...
        [Tooltip("Whether to automatically generate a curve from the GameObject's current position to the beginning of the path. True by default."), ActionSection("Path")]
        ...
        [CompoundArray("Path Nodes", "Transform", "Vector"), Tooltip("A list of objects to draw a Catmull-Rom spline through for a curved animation path.")]
