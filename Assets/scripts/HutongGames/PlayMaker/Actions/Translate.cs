namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Translates a Game Object. Use a Vector3 variable and/or XYZ components. To leave any axis unchanged, set variable to 'None'."), ActionCategory(ActionCategory.Transform)]
    public class Translate : FsmStateAction
    {
        ...
        public Space space;
        [UIHint(UIHint.Variable), Tooltip("A translation vector. NOTE: You can override individual axis below.")]
