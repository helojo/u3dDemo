namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionCategory(ActionCategory.Camera), Tooltip("Transforms position from screen space into world space. NOTE: Uses the MainCamera!")]
    public class ScreenToWorldPoint : FsmStateAction
    {
        ...
        [UIHint(UIHint.Variable), Tooltip("Store the world X position in a float variable.")]
