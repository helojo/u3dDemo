...
public class UIWidget : UIRect
{
    ...
    protected void UpdateFinalAlpha(int frameID)
    {
        ...
        {
            UIRect parent = base.parent;
            base.finalAlpha = (base.parent == null) ? this.mColor.a : (parent.CalculateFinalAlpha(frameID) * this.mColor.a);
        }
    }

    public bool UpdateGeometry(int frame, bool needAlpha)
    {
        if (!base.mChanged)
        {
        ...
        {
            base.mChanged = false;
            if ((this.mIsVisibleByAlpha && (base.finalAlpha > 0.001f)) && (this.shader != null))
            {
    ...
    public virtual Vector4 drawingDimensions
    {
        ...
        {
            Vector2 pivotOffset = this.pivotOffset;
            float from = -pivotOffset.x * this.mWidth;
            float num2 = -pivotOffset.y * this.mHeight;
            float to = from + this.mWidth;
            float num4 = num2 + this.mHeight;
            return new Vector4((this.mDrawRegion.x != 0f) ? Mathf.Lerp(from, to, this.mDrawRegion.x) : from, (this.mDrawRegion.y != 0f) ? Mathf.Lerp(num2, num4, this.mDrawRegion.y) : num2, (this.mDrawRegion.z != 1f) ? Mathf.Lerp(from, to, this.mDrawRegion.z) : to, (this.mDrawRegion.w != 1f) ? Mathf.Lerp(num2, num4, this.mDrawRegion.w) : num4);
        }
    }
    ...
    public bool hasBoxCollider
    {
        get
        {
            ...
            return ((collider != null) || (base.GetComponent<BoxCollider2D>() != null));
        }
    }
    ...
    public bool isVisible
    {
        get
        {
            return (((this.mIsVisibleByPanel && this.mIsVisibleByAlpha) && (this.mIsInFront && (base.finalAlpha > 0.001f))) && NGUITools.GetActive(this));
        }
    }
