namespace HutongGames.PlayMaker.Actions
{
    ...
    {
        [RequiredField, UIHint(UIHint.Animation), Tooltip("The name of the animation.")]
        public FsmString animName;
        [Tooltip("How the animation is blended with other animations on the Game Object.")]
        public AnimationBlendMode blendMode;
        [RequiredField, CheckForComponent(typeof(Animation)), Tooltip("A GameObject with an Animation Component.")]
        public FsmOwnerDefault gameObject;
        [Tooltip("The animation layer")]
        public FsmInt layer;
        [HasFloatSlider(0f, 5f), Tooltip("The speed of the animation. 1 = normal; 2 = double speed...")]
