namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Turns a Game Object on/off in a regular repeating pattern."), ActionCategory(ActionCategory.Effects)]
    public class Blink : FsmStateAction
    {
        ...
        [HasFloatSlider(0f, 5f), Tooltip("Time to stay off in seconds.")]
