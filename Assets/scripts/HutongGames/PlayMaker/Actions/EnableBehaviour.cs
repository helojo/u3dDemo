namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Enables/Disables a Behaviour on a GameObject. Optionally reset the Behaviour on exit - useful if you only want the Behaviour to be active while this state is active."), ActionCategory(ActionCategory.ScriptControl)]
    public class EnableBehaviour : FsmStateAction
    {
        [UIHint(UIHint.Behaviour), Tooltip("The name of the Behaviour to enable/disable.")]
        ...
        [RequiredField, Tooltip("The GameObject that owns the Behaviour.")]
