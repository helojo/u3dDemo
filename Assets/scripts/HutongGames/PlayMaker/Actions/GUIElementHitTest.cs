namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Performs a Hit Test on a Game Object with a GUITexture or GUIText component."), ActionCategory(ActionCategory.GUIElement)]
    public class GUIElementHitTest : FsmStateAction
    {
        ...
        [Tooltip("The GameObject that has a GUITexture or GUIText component."), RequiredField, CheckForComponent(typeof(GUIElement))]
