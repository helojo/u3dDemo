namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionCategory(ActionCategory.Color), Tooltip("Samples a Color on a continuous Colors gradient.")]
    public class ColorRamp : FsmStateAction
    {
        ...
        [Tooltip("Point on the gradient to sample. Should be between 0 and the number of colors in the gradient."), RequiredField]
