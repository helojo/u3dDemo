namespace HutongGames.PlayMaker.Actions
{
    ...
    public class ConvertFloatToString : FsmStateAction
    {
        ...
        [Tooltip("The float variable to convert."), UIHint(UIHint.Variable), RequiredField]
        public FsmFloat floatVariable;
        [Tooltip("Optional Format, allows for leading zeroes. E.g., 0000")]
        public FsmString format;
        [Tooltip("A string variable to store the converted value."), UIHint(UIHint.Variable), RequiredField]
