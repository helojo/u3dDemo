namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionCategory(ActionCategory.Animation), Tooltip("Captures the current pose of a hierarchy as an animation clip.\n\nUseful to blend from an arbitrary pose (e.g. a ragdoll death) back to a known animation (e.g. idle).")]
    public class CapturePoseAsAnimationClip : FsmStateAction
    {
        ...
        [ObjectType(typeof(AnimationClip)), UIHint(UIHint.Variable), RequiredField, Tooltip("Store the result in an Object variable of type AnimationClip.")]
