namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionCategory(ActionCategory.Character), Tooltip("Gets the Collision Flags from a Character Controller on a Game Object. Collision flags give you a broad overview of where the character collided with any other object.")]
    public class GetControllerCollisionFlags : FsmStateAction
    {
        ...
        [UIHint(UIHint.Variable), Tooltip("True if no collisions in last move.")]
        public FsmBool none;
        private GameObject previousGo;
        [Tooltip("True if the Character Controller capsule was hit on the sides."), UIHint(UIHint.Variable)]
