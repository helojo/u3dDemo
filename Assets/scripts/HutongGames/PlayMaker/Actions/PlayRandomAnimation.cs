namespace HutongGames.PlayMaker.Actions
{
    ...
    public class PlayRandomAnimation : FsmStateAction
    {
        ...
        [Tooltip("Time taken to blend to this animation."), HasFloatSlider(0f, 5f)]
        public FsmFloat blendTime;
        [Tooltip("Event to send when the animation is finished playing. NOTE: Not sent with Loop or PingPong wrap modes!")]
        public FsmEvent finishEvent;
        [Tooltip("Game Object to play the animation on."), RequiredField, CheckForComponent(typeof(Animation))]
