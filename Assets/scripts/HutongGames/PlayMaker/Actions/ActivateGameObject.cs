namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionCategory(ActionCategory.GameObject), Tooltip("Activates/deactivates a Game Object. Use this to hide/show areas, or enable/disable many Behaviours at once.")]
    public class ActivateGameObject : FsmStateAction
    {
        [RequiredField, Tooltip("Check to activate, uncheck to deactivate Game Object.")]
