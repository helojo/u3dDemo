namespace Fatefulness
{
    ...
    public class SetBuffActive : Concentrator
    {
        ...
        public override void Excude(Intent intent)
        {
            ...
            if (actor != null)
            {
                ...
                port.Review(intent2);
                int buffId = intent2.GetInt32(IntentDecl.variable);
                ...
                port.Review(intent2);
                int num2 = intent2.GetInt32(IntentDecl.variable);
                actor.ChangeBuffEffectActiveAndNotice(buffId, "wea_shield_o_sm_" + (num2 + 1), false);
            }
        }
