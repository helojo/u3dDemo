namespace HutongGames.PlayMaker.Actions
{
    ...
    public class GetAngleToTarget : FsmStateAction
    {
        ...
        [RequiredField, Tooltip("The game object whose forward axis we measure from. If the target is dead ahead the angle will be 0.")]
        public FsmOwnerDefault gameObject;
        [Tooltip("Ignore height differences when calculating the angle.")]
        public FsmBool ignoreHeight;
        [UIHint(UIHint.Variable), RequiredField, Tooltip("Store the angle in a float variable.")]
