namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionCategory(ActionCategory.Material), Tooltip("Sets a named texture in a game object's material.")]
    public class SetMaterialTexture : FsmStateAction
    {
        [Tooltip("The GameObject that the material is applied to."), CheckForComponent(typeof(Renderer))]
