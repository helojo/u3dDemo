...
public class UIScrollBar : UISlider
{
    ...
    public override void ForceUpdate()
    {
        ...
        {
            base.mIsDirty = false;
            float from = Mathf.Clamp01(this.mSize) * 0.5f;
            float num2 = Mathf.Lerp(from, 1f - from, base.value);
            float x = num2 - from;
            float z = num2 + from;
    ...
    {
        base.OnStart();
        if (((base.mFG != null) && (base.mFG.gameObject != base.gameObject)) && ((base.mFG.collider != null) || (base.mFG.GetComponent<Collider2D>() != null)))
        {
