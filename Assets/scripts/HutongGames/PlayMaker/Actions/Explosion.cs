namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionCategory(ActionCategory.Physics), Tooltip("Applies an explosion Force to all Game Objects with a Rigid Body inside a Radius.")]
    public class Explosion : FsmStateAction
    {
        ...
        [Tooltip("The strength of the explosion."), RequiredField]
