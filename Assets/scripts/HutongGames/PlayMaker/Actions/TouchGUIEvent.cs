namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionCategory(ActionCategory.Device), Tooltip("Sends events when a GUI Texture or GUI Text is touched. Optionally filter by a fingerID.")]
    public class TouchGUIEvent : FsmStateAction
    {
        [ActionSection(""), Tooltip("Repeate every frame.")]
        public bool everyFrame;
        [Tooltip("Only detect touches that match this fingerID, or set to None.")]
        public FsmInt fingerId;
        [RequiredField, CheckForComponent(typeof(GUIElement)), Tooltip("The Game Object that owns the GUI Texture or GUI Text.")]
