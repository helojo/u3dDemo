namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionCategory(ActionCategory.GameObject), Tooltip("Finds the Child of a GameObject by Name and/or Tag. Use this to find attach points etc. NOTE: This action will search recursively through all children and return the first match; To find a specific child use Find Child.")]
    public class GetChild : FsmStateAction
    {
        ...
        [UIHint(UIHint.Variable), Tooltip("Store the result in a GameObject variable."), RequiredField]
        public FsmGameObject storeResult;
        [Tooltip("The Tag to search for. If Child Name is set, both name and Tag need to match."), UIHint(UIHint.Tag)]
