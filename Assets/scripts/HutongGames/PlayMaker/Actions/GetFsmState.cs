namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionCategory(ActionCategory.StateMachine), Tooltip("Gets the name of the specified FSMs current state. Either reference the fsm component directly, or find it on a game object.")]
    public class GetFsmState : FsmStateAction
    {
        ...
        [UIHint(UIHint.FsmName), Tooltip("Optional name of Fsm on Game Object. If left blank it will find the first PlayMakerFSM on the GameObject.")]
        public FsmString fsmName;
        [Tooltip("If not specifyng the component above, specify the GameObject that owns the FSM")]
        public FsmOwnerDefault gameObject;
        [RequiredField, UIHint(UIHint.Variable), Tooltip("Store the state name in a string variable.")]
