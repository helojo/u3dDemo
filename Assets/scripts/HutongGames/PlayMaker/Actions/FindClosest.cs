namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Finds the closest object to the specified Game Object.\nOptionally filter by Tag and Visibility."), ActionCategory(ActionCategory.GameObject)]
    public class FindClosest : FsmStateAction
    {
        [Tooltip("Repeat every frame")]
        public bool everyFrame;
        [Tooltip("The GameObject to measure from."), RequiredField]
        ...
        [Tooltip("Store the closest object."), UIHint(UIHint.Variable)]
        public FsmGameObject storeObject;
        [UIHint(UIHint.Tag), RequiredField, Tooltip("Only consider objects with this Tag. NOTE: It's generally a lot quicker to find objects with a Tag!")]
