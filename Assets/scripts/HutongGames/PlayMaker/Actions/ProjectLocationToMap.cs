namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionCategory(ActionCategory.Device), Tooltip("Projects the location found with Get Location Info to a 2d map using common projections.")]
    public class ProjectLocationToMap : FsmStateAction
    {
        ...
        [UIHint(UIHint.Variable), Tooltip("Store the projected Y coordinate in a Float Variable. Use this to display a marker on the map.")]
