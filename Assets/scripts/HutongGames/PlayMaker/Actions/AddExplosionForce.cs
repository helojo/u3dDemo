namespace HutongGames.PlayMaker.Actions
{
    ...
    {
        [RequiredField, Tooltip("The center of the explosion. Hint: this is often the position returned from a GetCollisionInfo action.")]
        ...
        [RequiredField, Tooltip("The GameObject to add the explosion force to."), CheckForComponent(typeof(Rigidbody))]
