...
public class UIProgressBar : UIWidgetContainer
{
    ...
    public virtual void ForceUpdate()
    {
        ...
        if ((this.thumb != null) && ((this.mFG != null) || (this.mBG != null)))
        {
            ...
            if (this.isHorizontal)
            {
                Vector3 from = Vector3.Lerp(vectorArray[0], vectorArray[1], 0.5f);
                Vector3 to = Vector3.Lerp(vectorArray[2], vectorArray[3], 0.5f);
    ...
    protected bool isHorizontal
    {
        get
        {
            return ((this.mFill == FillDirection.LeftToRight) || (this.mFill == FillDirection.RightToLeft));
        }
    }
    ...
    protected bool isInverted
    {
        get
        {
            return ((this.mFill == FillDirection.RightToLeft) || (this.mFill == FillDirection.TopToBottom));
        }
    }
    ...
    public float value
    {
        ...
        set
        {
            ...
            if (this.mValue != num)
            {
                ...
                this.mValue = num;
                if (((num2 == 0f) && (num != 0f)) && (this.mFG != null))
                {
                    NGUITools.SetActive(this.mFG.gameObject, true);
                }
                else if (((num2 != 0f) && (num == 0f)) && (this.mFG != null))
                {
                    NGUITools.SetActive(this.mFG.gameObject, false);
                }
                if (num2 != this.value)
                {
                    this.ForceUpdate();
