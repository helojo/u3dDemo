namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionCategory(ActionCategory.Physics), Tooltip("Adds torque (rotational force) to a Game Object.")]
    public class AddTorque : FsmStateAction
    {
        ...
        [RequiredField, Tooltip("The GameObject to add torque to."), CheckForComponent(typeof(Rigidbody))]
        public FsmOwnerDefault gameObject;
        [Tooltip("Apply the force in world or local space.")]
        public Space space;
        [Tooltip("A Vector3 torque. Optionally override any axis with the X, Y, Z parameters."), UIHint(UIHint.Variable)]
