namespace HutongGames.PlayMaker.Actions
{
    ...
    [ActionCategory(ActionCategory.StateMachine), Tooltip("Set the value of a Texture Variable in another FSM.")]
    public class SetFsmTexture : FsmStateAction
    {
        ...
        [UIHint(UIHint.FsmTexture), RequiredField, Tooltip("The name of the FSM variable.")]
