...
public abstract class UIBasicSprite : UIWidget
{
                        ...
                        if (((this.centerType != AdvancedType.Invisible) || (i != 1)) || (j != 1))
                        {
                            ...
                            if ((i == 1) && (j == 1))
                            {
                                if (this.centerType == AdvancedType.Tiled)
                                {
                                    ...
                                    float from = mTempUVs[i].x;
                                    float num10 = mTempUVs[j].y;
                                    for (float k = y; k < num8; k += vector3.y)
                                    {
                                        float num12 = x;
                                        float to = mTempUVs[num4].y;
                                        float num14 = k + vector3.y;
                                        if (num14 > num8)
                                        {
                                            to = Mathf.Lerp(num10, to, (num8 - k) / vector3.y);
                                            num14 = num8;
                                        }
                                        while (num12 < num6)
                                        {
                                            ...
                                            if (num15 > num6)
                                            {
                                                num16 = Mathf.Lerp(from, num16, (num6 - num12) / vector3.x);
                                                num15 = num6;
                                            }
                                            Fill(verts, uvs, cols, num12, num15, k, num14, from, num16, num10, to, (Color) drawingColor);
                                            num12 += vector3.x;
                                        }
                                    }
                                }
                            ...
                            else if (i == 1)
                            {
                                ...
                                else if (((j == 0) && (this.bottomType == AdvancedType.Sliced)) || ((j == 2) && (this.topType == AdvancedType.Sliced)))
                                {
                                    Fill(verts, uvs, cols, mTempPos[i].x, mTempPos[index].x, mTempPos[j].y, mTempPos[num4].y, mTempUVs[i].x, mTempUVs[index].x, mTempUVs[j].y, mTempUVs[num4].y, (Color) drawingColor);
                                }
                            }
                            else if (j == 1)
                            {
                                ...
                                else if (((i == 0) && (this.leftType == AdvancedType.Sliced)) || ((i == 2) && (this.rightType == AdvancedType.Sliced)))
                                {
                                    Fill(verts, uvs, cols, mTempPos[i].x, mTempPos[index].x, mTempPos[j].y, mTempPos[num4].y, mTempUVs[i].x, mTempUVs[index].x, mTempUVs[j].y, mTempUVs[num4].y, (Color) drawingColor);
                                }
                            }
    ...
    private Color32 drawingColor
    {
        get
        {
            Color c = base.color;
            c.a = base.finalAlpha;
            return (!this.premultipliedAlpha ? c : NGUITools.ApplyPMA(c));
        }
    }
