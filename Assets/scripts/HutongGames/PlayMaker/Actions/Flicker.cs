namespace HutongGames.PlayMaker.Actions
{
    ...
    {
        [HasFloatSlider(0f, 1f), Tooltip("Amount of time flicker is On (0-1). E.g. Use 0.95 for an occasional flicker.")]
        public FsmFloat amountOn;
        [HasFloatSlider(0f, 1f), Tooltip("The frequency of the flicker in seconds.")]
        public FsmFloat frequency;
        [RequiredField, Tooltip("The GameObject to flicker.")]
